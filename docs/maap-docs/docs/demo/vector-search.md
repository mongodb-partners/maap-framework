...
### Making queries 
    ...
    The queries can be asked based on the data ingested and relevant data can be retrieved based on the score.
    The below fields will be returned for each relevant document.
