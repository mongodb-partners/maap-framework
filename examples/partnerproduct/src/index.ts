...
import { getModelClass, getEmbeddingModel, getDatabaseConfigInfo } from '../../../src/yaml_parser/src/LoadYaml.js';
import { convertBaseEmbeddingsToEmbedder, convertBaseModelToChatLlm } from '../../../src/index.js';
...
// TODO: Make this path relative w/in the repo, not absolute in your local env
...
const { dbName, connectionString, vectorSearchIndexName } = getDatabaseConfigInfo();
